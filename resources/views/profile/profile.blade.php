            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="margin:0 auto;max-width:500px">
                            ...
                            <div class="text-center" id="author">
                                <table class="table table-th-block">
                                    <tbody>
                                        <tr>
                                            ...
                                            @if ($user->isOnline())
                                            <td style="color:greenyellow"> Онлайн</td></tr>
                                        @else
                                ...
                                @if (!Auth::guest())
                                    @if (Auth::user()->role == 1 or Auth::user()->role == 2)
                                        <a href="{{route('profile.edit',['id'=>$user->id]) }}" class="more-link button pull-left">Изменить данные</a>
                                        <a href="{{route('profile.destroy',$user->id)}}" onclick="return confirm('Удалить профиль?')" class="more-link button pull-right">Удалить профиль</a>
                                    @endif
                                @endif
                            </div>
                        </div>
