                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" placeholder="Полное описание события" cols="30" rows="10" class="form-control">@if(!empty($errors->first('*'))){{old('content')}}@else{{$all->content}}@endif</textarea></textarea>
