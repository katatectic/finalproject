            ...
            <main id="main" class="site-main" role="main">
                ...
                <article id="post-519" class="post-519 doublef-event type-doublef-event status-publish has-post-thumbnail hentry doublef-events-school-events">
                    ...
                    <header class="entry-header">
                        ...
                        <h3 class="doublef-event-item-date">Кто создал <a href="{{route('profile',['id'=>$event->user->id])}}">{{$event->user->name}}<a></h3>
                                            ...
                                            <div class="comment byuser comment-author-adminschool bypostauthor even thread-even depth-1" id="comment-7">
                                                <div class="avatar clear">
                                                    ...
                                                    <div class="avatar-body pull-left">
                                                        <h6 class="avatar-name"><a href="{{route('profile',['id'=>$comment->user->id])}}">{{$comment->user->name}} {{$comment->user->surname}}<a/></h6>
                                                ...
                                                <p><a style="float:right" onclick="return confirmDeleteComment();" href="{{route('deleteComment',$comment->id)}}" class="more-link button">Удалить комментарий</a></p>
                                                @endif
                                            </div><!-- #comment-## -->
                                        </div><!-- .comment-list -->
                                        @endforeach
