        ...
        <div id="primary" class="content-area grid__col grid__col--3-of-3">
            <main id="main" class="site-main" role="main">
                ...
                <article id="post-519" class="post-519 doublef-event type-doublef-event status-publish has-post-thumbnail hentry doublef-events-school-events">                    
                    ...
                    <img width="500" src="{{asset('images/reports/'.$report->pay_check)}}" class="attachment-full size-full wp-post-image" alt="" srcset="{{asset('images/news/'.$report->pay_check)}} 1140w, {{asset('images/news/'.$report->pay_check)}} 600w" sizes="(max-width: 1140px) 100vw, 1140px"/>
