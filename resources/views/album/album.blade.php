...
<a href="{{route('albumcreate')}}">Создать новый альбом</a>
        </div>
    @if($album)
		<div>
      <div class="starter-template">
        <div class="media">    
          ...
          <a href="{{URL::route('add_image',array('id'=>$album->id))}}"><button type="button"class="btn btn-primary btn-large">Добавить новой фото в альбом</button></a>
        ...
        @foreach($album->Photos as $photo)
          <div class="col-lg-3">
            <div class="thumbnail" style="max-height:350px;min-height: 350px;">
              <img alt="{{$photo->name}}" style="nx width:150px;max-height:150px"src="{{asset('images/albums/photos/'.$photo->image)}}">
              <div class="caption">
