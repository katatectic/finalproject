...
<div id="cinemahead">
    <div class="buntington2-cinema-bg">
        <div class="element-gradient buntington2-cinema buntington2-cinema-page invert" data-url="http://bel-gazeta.ru/wp-content/uploads/2018/03/discussion59eedc6c8b782-678x300.jpg" style="background-position: center center; padding-top: 350px; padding-bottom: 40px;">
            <div class="wrappr text-left">
                <h1 class="h-gigant">Родительский комитет 5-А класса ОШ №25</h1>
                <p>Состав коммитета, общая информация.</p>
            </div>
        </div>
    </div>
